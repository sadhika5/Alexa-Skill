...
def get_compliment():
    ...
    compliments = ["You have a great smile.", "You are very smart.","You are a great cook.","You are so athletic" ]
    speech_output = compliments[random.randint(0,len(compliments)-1)]
    reprompt_text = "You arms are so big."
...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to your conversation application!"
